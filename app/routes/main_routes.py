...
from app.models import Tip, FixtureFree
...
def home():
    ...
    return render_template('home.html', tips=tips, tip_map=tip_map, result_map=result_map, round_number=round_number, fixtures=fixtures, team_logos=TEAM_LOGOS, current_year=datetime.now().year)
